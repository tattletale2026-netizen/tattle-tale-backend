...
def create_booking():
    try:
        ...
        user_html = f"<h3>Hello {greeting_name}</h3><p>Your seat is confirmed! Thank you for booking with Tattle Tale.</p>"
...
def submit_contact():
    try:
        ...
        send_resend_email(os.environ.get('MAIL_TO'), "New Contact Message - Tattle Tale", admin_html)
